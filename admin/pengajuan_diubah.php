                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form id="form_pengajuan_diterima" method="post" action="system/proses_pengajuan_berubah.php">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="jadwal_pelaksanaan" id="form_pengajuan_diterima" required class="form-control" value="<?php echo $jadwal_pelaksanaan ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Catatan</label>
                                                <textarea rows="5" name="catatan" id="form_pengajuan_diterima" class="form-control" placeholder="Silakan isi catatan disini "><?php echo $catatan; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div align="right">
<?php
                                        echo '<a href="detail_pengajuan.php?id='.$data['id_pengajuan'].'">
